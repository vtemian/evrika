				...
				if(isset($_POST[submit])){
					if(trim($_POST[titlu])!=''){
						if(trim($_POST[content])!=''){
							...
							$result=mysql_query($query);
							if($result){
								echo '<center><h2>Datele au fost introduse cu succes<br /><a href="admin_stiri.php">Inapoi</a></h2></center>';
							}else
								echo '<center><h2>Eroare la introducerea datelor<br /><a href="admin_stiri.php">Inapoi</a></h2></center>';
						}else
							echo '<center><h2>Trebuie sa adugati ceva in acea stire<br /><a href="admin_stiri.php">Inapoi</a></h2></center>';
					}else
						echo '<center><h2>Trebuie sa alegeti un titlu<br /><a href="admin_stiri.php">Inapoi</a></h2></center>';
					...
					echo '<h2>Adaugare</h2><br />
							<hr class="clear-contentunit"/><br />
							<div class="useri">
								<form action="admin_stiri.php" method="post">
									
										<h3>Titlu</h3>
										<div><input type="text" name="titlu" class="field" /><br /></div>
										<h3>Continut<br /><br /></h3>
										<div><textarea name="content" rows="" cols=""></textarea><br /></div>
