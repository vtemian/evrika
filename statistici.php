		...
		<?php
			if(isset($_POST[trimite])){
				...
				echo '<form action="statistici.php" method="post">
					...
					<div><input type="submit" class="button" name="trimite" value="Trimite" /></div>
				</form>';
				echo '<img src="img_1.php" alt="" />
			Statistic&#259; premii total<br />clasa 8 <br />
			<br /><br /><img src="img_clspct.php?cls=VIII" alt="" />
			<br /><br /><img src="img_cls8.php" alt="" />
			<br />clasa 9 <br />
			<br /><br /><img src="img_clspct.php?cls=IX" alt="" />
			<br /><br /><img src="img_cls9.php" alt="" />
			<br />clasa 10 <br />
			<br /><br /><img src="img_clspct.php?cls=X" alt="" />
			<br /><br /><img src="img_cls10.php" alt="" />
			<br />clasa 11 <br />
			<br /><br /><img src="img_clspct.php?cls=XI" alt="" />
			<br /><br /><img src="img_cls11.php" alt="" />
			<br />clasa 12 <br />
			<br /><br /><img src="img_clspct.php?cls=XII" alt="" />
			<br /><br /><img src="img_cls12.php" alt="" />';
			}			
