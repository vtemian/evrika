<?php
		...
		connect(onc);
		$query="SELECT * FROM rezultate,participanti WHERE rezultate.id_elev=participanti.id AND participanti.cls='XI'";
		$result=mysql_query($query);
		$tot=mysql_num_rows($result);
		$query="SELECT * FROM rezultate,participanti WHERE rezultate.id_elev=participanti.id AND participanti.cls='XI' AND rezultate.premiu='I'";
		$result=mysql_query($query);
		$unu=mysql_num_rows($result);
		$query="SELECT * FROM rezultate,participanti WHERE rezultate.id_elev=participanti.id AND participanti.cls='XI' AND rezultate.premiu='II'";
		$result=mysql_query($query);
		$doi=mysql_num_rows($result);
		$query="SELECT * FROM rezultate,participanti WHERE rezultate.id_elev=participanti.id AND participanti.cls='XI' AND rezultate.premiu='III'";
		$result=mysql_query($query);
		$trei=mysql_num_rows($result);
		$query="SELECT * FROM rezultate,participanti WHERE rezultate.id_elev=participanti.id AND participanti.cls='XI' AND rezultate.premiu='M'";
		$result=mysql_query($query);
