<?php
		...
		$query="SELECT * FROM rezultate WHERE premiu='I'";
		$result=mysql_query($query);
		$unu=mysql_num_rows($result);
		$query="SELECT * FROM rezultate WHERE premiu='II'";
		$result=mysql_query($query);
		$doi=mysql_num_rows($result);
		$query="SELECT * FROM rezultate WHERE premiu='III'";
		$result=mysql_query($query);
		$trei=mysql_num_rows($result);
		$query="SELECT * FROM rezultate WHERE premiu='M'";
		$result=mysql_query($query);
		...
		$culoarecerc4=imagecolorallocate($img,255,0,0);
		$x1=30;
		$y1=100;
		$x2=40;
		$y2=100-(100*$unu/$tot);
		imagefilledrectangle($img, $x1, $y1, $x2, $y2, $culoarecerc2);
		imagestring ($img, 4, $x2-12, $y2-20,$unu, $culoarecerc2);
		imagestring ($img, 4, $x1, 110,'I', $culoarecerc2);
		$x1+=30;
		$x2+=30;
		$y2=100-(100*$doi/$tot);
		imagefilledrectangle($img, $x1, $y1, $x2, $y2, $culoarecerc4);
		imagestring ($img, 4, $x2-12, $y2-20,$doi, $culoarecerc2);
		imagestring ($img, 4, $x1-3, 110,'II', $culoarecerc2);
		$x1+=30;
		$x2+=30;
		$y2=100-(100*$trei/$tot);
		imagefilledrectangle($img, $x1, $y1, $x2, $y2, $culoarecerc4);
		imagestring ($img, 4, $x2-12, $y2-20,$trei, $culoarecerc2);
		imagestring ($img, 4, $x1-7, 110,'III', $culoarecerc2);
		$x1+=30;
		$x2+=30;
		$y2=100-(100*$mentiune/$tot);
		imagefilledrectangle($img, $x1, $y1, $x2, $y2, $culoarecerc4);
		imagestring ($img, 4, $x2-12, $y2-20,$mentiune, $culoarecerc2);
		imagestring ($img, 4, $x1, 110,'M', $culoarecerc2);
		$x1+=50;
		$x2+=50;
		$y2=100-(100*($tot-($unu+$doi+$trei+$mentiune))/$tot);
		imagefilledrectangle($img, $x1, $y1, $x2, $y2, $culoarecerc4);
		imagestring ($img, 4, $x2-12, $y2-20,$tot-($unu+$doi+$trei+$mentiune), $culoarecerc2);
